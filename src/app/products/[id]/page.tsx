...
import { ChevronRight, Star, Heart, Minus, Plus, ShoppingBag, ChevronDown, ChevronUp } from "lucide-react";
import { FadeIn, StaggerContainer, StaggerItem } from "@/components/animations/FadeIn";

// Dummy product data
const product = {
  id: "1",
  name: "Áo Thun Basic Oversize Màu Kem",
  price: 250000,
  originalPrice: 350000,
  rating: 4.8,
  reviews: 124,
  description: "Áo thun form rộng thoải mái, chất liệu cotton 100% thoáng mát, thấm hút mồ hôi tốt. Phù hợp cho những ngày dạo phố năng động.",
  images: [
  ...
  colors: [
    { name: "Kem", hex: "#FBF8F3" },
    { name: "Nâu Sẫm", hex: "#554841" },
    { name: "Đất Nung", hex: "#C18676" },
  ],
  sizes: ["S", "M", "L", "XL"]
};
  ...
  return (
    <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div className="flex items-center">
              ...
              <Link href="/category/men" className="hover:text-brand-accent transition-colors">
                Thời trang nam
              </Link>
            </div>
          </li>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <StaggerContainer delay={0.2} className="flex flex-col">
          <StaggerItem>
          ...
          <StaggerItem>
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              {/* Add to cart */}
              <button className="flex-1 bg-brand-dark text-white rounded-xl flex items-center justify-center font-bold py-3 hover:bg-brand-dark/90 transition-colors">
                <ShoppingBag className="w-5 h-5 mr-2" />
                Thêm vào giỏ
              </button>

              {/* Wishlist */}
              <button className="sm:w-14 w-full h-14 sm:h-auto border-2 border-gray-200 rounded-xl flex items-center justify-center text-gray-500 hover:border-red-500 hover:text-red-500 transition-colors">
            ...
            <div className="border-t border-gray-100 pt-6 space-y-2">
              ...
              <div className="border-b border-gray-100 pb-2">
                ...
                >
                  ...
                  {openAccordion === "details" ? <ChevronUp className="w-5 h-5 text-brand-dark" /> : <ChevronDown className="w-5 h-5 text-brand-dark" />}
                </button>
              ...
              <div className="border-b border-gray-100 pb-2">
                ...
                >
                  ...
                  {openAccordion === "shipping" ? <ChevronUp className="w-5 h-5 text-brand-dark" /> : <ChevronDown className="w-5 h-5 text-brand-dark" />}
                </button>
              ...
              <div className="border-b border-gray-100 pb-2">
                ...
                >
                  ...
                  {openAccordion === "returns" ? <ChevronUp className="w-5 h-5 text-brand-dark" /> : <ChevronDown className="w-5 h-5 text-brand-dark" />}
                </button>
